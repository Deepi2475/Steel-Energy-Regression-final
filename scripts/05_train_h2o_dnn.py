...
def main():
    ...
    # Initialize H2O and clear any previous frames
    h2o.init()
    h2o.remove_all()
    ...
    with mlflow.start_run(run_name="h2o_dnn"):
        ...
        mlflow.h2o.log_model(model, "model", registered_model_name="steel_energy_dnn")

    print("H2O DeepLearning training completed.")
